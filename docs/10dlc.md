...
This guide explains how to register a 10DLC Brand and Campaign to send messages using US local 10-digit long codes
...
###### Fig. 2 Campaign details and use case
...
###### Fig. 4 Additional opt-in, opt-out, and help keywords
